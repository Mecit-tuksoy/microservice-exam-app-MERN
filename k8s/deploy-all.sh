...
echo "Hosts dosyanıza ekleyin: $MINIKUBE_IP exam-app.local"
...
kubectl apply -f storage-service-claim0-persistentvolumeclaim.yaml
...
echo "$MINIKUBE_IP exam-app.local"
echo "Ardından tarayıcınızdan http://exam-app.local/ adresine gidebilirsiniz."
